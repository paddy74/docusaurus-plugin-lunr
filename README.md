...
[![npm version](https://badge.fury.io/js/docusaurus-plugin-lunr.svg)](https://www.npmjs.com/package/docusaurus-plugin-lunr)

## Sample

```html
<p align="center">
<img width="548" alt="image" src="https://github.com/paddy74/docusaurus-plugin-lunr/assets/20218070/dbc54b61-077f-4e11-af27-8798cae8a572.gif">
</p>
```
...
docusaurus-plugin-lunr sets the default value for fields to:
